# Estructura del reporte — bloque por bloque
...
## 8 · Próximos pasos
- 3–4 focos con **postura** (recomendación clara), ordenados por impacto.
- Incluí las **decisiones / hipótesis a validar con el cliente** (ej. estrategia de retail/marketplaces,
  presupuesto para el próximo evento) — como preguntas, no afirmaciones.
